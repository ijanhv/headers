        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <Link href="https://flowbite.com/" className="flex items-center">
                  <Image src="https://1000logos.net/wp-content/uploads/2016/10/Budweiser-Logo-1999-2011.png"
                  width={32}
                    height={32}
unoptimized
className="h-8 me-3" alt="FlowBite Logo" />
                  <span className="self-center text-2xl font-semibold whitespace-nowrap font-seasonsRegular text-white">
                    Budweiser
                  </span>
              </Link> 
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 text-white">
              <div>
                  ...
                  <ul className="ext-gray-400 font-medium">
                      <li className="mb-4">
